...
ALTER TABLE ALBUMS
ADD CONSTRAINT PHOTO_EXISTS FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS (PHOTO_ID) ON DELETE CASCADE
INITIALLY DEFERRED DEFERRABLE;

ALTER TABLE PHOTOS
ADD CONSTRAINT ALBUM_EXISTS FOREIGN KEY (ALBUM_ID) REFERENCES ALBUMS (ALBUM_ID) ON DELETE CASCADE
INITIALLY DEFERRED DEFERRABLE;
